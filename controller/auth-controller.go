...
func (c *authController) Login(ctx *gin.Context) {
	...
	if v, ok := authResult.(entity.UserJoin); ok {
	...
	response := helper.BuildErrorResponse("Please check again your Password or UserName", "Invalid Password or UserName", helper.EmptyObj{})
